...
const List = () => {
    ...
    return (
        <div id="shopping-list">
            ...
            <h1>Shopping list</h1>
            <button className="delete" onClick={deleteAll}>Clear list</button>
            ...
            <div key={recipe.id}> {recipe.sections.map(section => (<p> {
                ...
                <li>
                    <p className='ingredient' onClick={(e) => e.target.classList.toggle('checked')} >&#8226; {components.ingredient.display_singular} </p>
                </li>
